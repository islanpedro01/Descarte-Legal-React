export default function Footer() {
    return (
        <footer className="relative z-10 bg-white pt-20 lg:pt-[120px] shadow ">
            ...
            <div className="mb-10 w-full">
              ...
              >
                <img
                  ...
                  alt="logo"
                  className="rounded-full outline outline-offset-2 outline-musgo"
                />
              </a>
          ...
          <div className="w-full mx-auto px-4 mt-5 sm:w-1/2">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center w-full">
                <a
                  href="javascript:void(0)"
                  className="flex flex-1 m-1 h-8 w-16 items-center justify-center rounded-full border border-[#E5E5E5] hover:border-primary hover:bg-musgo p-1 "
                >
                  <svg
                    width={8}
                    height={16}
                ...
                <a
                  href="javascript:void(0)"
                  className="flex flex-1 h-8 w-16 items-center justify-center rounded-full border border-[#E5E5E5] hover:border-primary hover:bg-musgo p-1 "
                >
                  <svg
                    width={16}
                    height={12}
